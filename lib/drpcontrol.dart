    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          var statusIcon = const Icon(Icons.pause_circle_outline_outlined,size: 50,);
          switch (frpEvent.playbackStatus) {
            case "flutter_radio_playing":
              statusIcon = const Icon(Icons.pause_circle_outline_outlined,size: 50,);
              break;
            case "flutter_radio_paused":
              statusIcon = const Icon(Icons.play_circle_outline_outlined,size: 50,);
              break;
            case "flutter_radio_loading":
              statusIcon = const Icon(Icons.refresh_rounded,size: 50,);
              break;
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            icon: const Icon(Icons.stop_circle_outlined,size: 50,color: Colors.red,),
                          ),
                          IconButton(
                            onPressed: () async {
